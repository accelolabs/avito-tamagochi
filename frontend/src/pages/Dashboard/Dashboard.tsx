        ...
        <div className="dashboard">
                ...
                <div className="dashboard__progress-bars">
                    <div className="dashboard__progress">
                        ...
                        <div className="dashboard__progress-bar">
                            <div className="dashboard__progress-fill" style={{ width: '0%' }}>0%</div>
                        </div>
                    </div>
                    <div className="dashboard__progress">
                        <div className="dashboard__progress-info">
                        ...
                        <div className="dashboard__progress-bar">
                            <div className="dashboard__progress-fill" style={{ width: '85%' }}>85%</div>
                        </div>
                    </div>
                </div>
            ...
            <div className="dashboard__stats">
                <div className="dashboard__stat-card">
                    ...
                    <p>2 / 3</p>
                    <svg className="dashboard__stat-icon" width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="dashboard__stat-card">
                    ...
                    <p>1</p>
                    <svg className="dashboard__stat-icon" width="99" height="81" viewBox="0 0 99 81" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="dashboard__stat-card">
                    ...
                    <p>5</p>
                    <svg className="dashboard__stat-icon" width="94" height="58" viewBox="0 0 94 58" fill="none" xmlns="http://www.w3.org/2000/svg">
